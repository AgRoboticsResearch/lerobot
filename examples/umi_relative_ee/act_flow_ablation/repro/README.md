...
- `physical_dynamics_h10.{csv,md}` — repository-tracked 126-row summary
  ...
  (W=3/4/5/10), all with measured physical metrics), with matched point
  estimate / 95% CI columns for rotational and XYZ velocity, acceleration,
  and jerk. Regenerated by the canonical compiler invocation below.
...
- `configs/` — per-run training configuration (`<RUN>.config.json`) copied
  ...
  5 each, added 2026-08-29/30, §9.2.20), and the LingBot-VA arm (3, added
  2026-08-26; trained on-host at
