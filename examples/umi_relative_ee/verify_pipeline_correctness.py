...
def test_stats_computation():
    ...
    valid_starts = _valid_query_starts(episode_index, chunk_size + 1)
    ...
    for start in valid_starts[:5]:  # Check first 5
        ...
        for offset in range(chunk_size):
            ...
            # Manual SE(3)
            manual_rel = _absolute_aa_to_relative_rot6d(state, action_abs)
    ...
    for start in valid_starts[:5]:
        ...
        rel = _absolute_aa_to_relative_rot6d(state, action_abs)
