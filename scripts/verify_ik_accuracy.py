...
"""
Verifies IK accuracy by comparing FK results with VIO targets.
"""
...
# Set initial configuration (same as replay script)
...
axs[0].set_title('Trajectory Tracking (XYZ)')
...
plt.tight_layout()
output_plot = "ik_accuracy_plot.png"
